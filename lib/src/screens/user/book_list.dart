...
import 'package:cant_lib/src/screens/book_list/book_details.dart';
...
SizedBox(height: 20,),
                ...
                Row(
                  ...
                  children: [
                SktText(text: "Showing ${((bController.bookPageableList.value.size??0)*(bController.bookPageableList.value.number??0)+bController.bookPageableList.value.content!.length)} of ${bController.bookPageableList.value.totalElements??0} History",fsize: 18,),
Spacer(),

                    if(bController.bookPageableList.value.number!>0) 
                    IconButton(onPressed: (){
                      bookController.searchBook(_serachItem, page: bController.bookPageableList.value.number!-1);
                ...
                SizedBox(height: 20,),
                    ...
                    TableCell(child: Padding( 
                              ...
                              TableCell(child: Padding( 
                               ...
                               TableCell(child: Padding( 
                                  ...
                                  child:SktButton(text: "Details", onPress: (){
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>BookDetails(book: nameone)));
                                  })
                                )
                              ),
                           ...
                           if(bookController.bookPageableList.value==null|| bookController.bookPageableList.value.content==null || bookController.bookPageableList.value.content!.isEmpty) SktText(text: "$_serachItem Book Not Found")
...
//   }
 ...
 Expanded(
  ...
  _onSubmit(val) {
    ...
    bookController.clearBookList();
    _serachItem=_searchController.text.toString();

    if(_serachItem.isEmpty){
        _serachItem=" ";
    }

    bookController.searchBook(_serachItem);
  }
}
